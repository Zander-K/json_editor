                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        onChanged: (value) {
                          context.read<JsonBloc>().add(
                                JsonEvent.onChangedDescription(value: value),
                              );
                        },
                      ),
                      CustomTextField(
                        ...
                        onChanged: (value) {
                          context.read<JsonBloc>().add(
                                JsonEvent.onChangedButtonText(value: value),
                              );
                        },
                      ),
                      ...
                      CustomDropdown<String>(
                        label: capitalize(JsonKeys.closeButtonNavigation.name),
                      ...
                      CustomDropdown<String>(
                        ...
                        items: ColorOptions.values.map((e) => e.name).toList(),
                        onChanged: (value) {
                          context.read<JsonBloc>().add(
                      ...
                      CustomDropdown<String>(
                        label: capitalize(JsonKeys.modalBackgroundColor.name),
                      ...
                      CustomDropdown<int>(
                        ...
                        items:
                            PaddingOptions.values.map((e) => e.value).toList(),
                        onChanged: (value) {
                          context.read<JsonBloc>().add(
                                JsonEvent.onChangedBodyPadding(value: value),
                              );
                        },
                      ),
                      CustomDropdown<int>(
                        ...
                        onChanged: (value) {
                          context.read<JsonBloc>().add(
                                JsonEvent.onChangedButtonPadding(value: value),
                              );
                        },
                      ),
                      CustomDropdown<bool>(
                      ...
                      UrlTestingTextField(
                        ...
                        onChanged: (value) {
                          context.read<JsonBloc>().add(
                                JsonEvent.onChangedRedirectURL(value: value),
                              );
                        },
                      ),
                    ],
